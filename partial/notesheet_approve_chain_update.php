<?php
    ...
    $chainDetails   = getDataRowByTableAndId('notesheet_access_chain', $chainId);
...
<form role="form" method="post" action="">
    ...
    <div class="box-footer">
        <input type="submit" name="notesheet_chain_create" class="btn btn-primary btn-block" value="Update">
    </div>
</form>