    ...
    <div class="table-responsive">
        <table id="rlp_list_table" class="table table-bordered table-striped list-table-custom-style">
            ...
            <tbody>
                <?php
                $sl = 0;
                $delUrl =   "function/user_management.php?process_type=department_delete";
                foreach ($agencyData as $adata) {
                    ...
                    <tr id="row_id_<?php echo $adata->id; ?>">
                        ...
                        <td>
                            ...
                            <a title="Edit User" class="btn btn-sm btn-info" href="department_update.php?department_id=<?php echo $adata->id; ?>">
