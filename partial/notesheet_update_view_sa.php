    ...
    <div class="col-md-4">
        ...
        <form id="rlp_sa_update_form">
            <div class="common_individual_section department_heads_section_style">
                ...
                <?php
                $department_id = $notesheets_master->request_department;
...
?>
            ...
            <div class="common_individual_section approval_body_section_style">
                ...
                <div class="radio">
                    <label><input type="radio" name="acknowledgement" value="2" <?php if (isset($rlp_info->notesheet_status) && $rlp_info->notesheet_status == 2) {
    echo "checked";
} ?>>Acknowledge</label>
                </div>
                <div class="radio">
                    <label><input type="radio" name="acknowledgement" value="4"  <?php if (isset($rlp_info->notesheet_status) && $rlp_info->notesheet_status == 4) {
    echo "checked";
} ?>>Onheld</label>
                </div>
            </div>
