(function($) {
    $.fn.bomTransfer = function(options) {
        var settings = $.extend({}, $.fn.bomTransfer.defaults, options);
        var _this;
        /* #=============================================================================== */
        ...
        return this.each(function() {
            ...
            /* # Add widget markup */
            /* #=============================================================================== */
            _this.append($.fn.bomTransfer.defaults.template);
            ...
            _this.data('bomTransfer', _this);
            return _this;
        });
    };
    $.fn.bomTransfer.defaults = {
                ...
                <tr>\
                    ...
                    <td width="48%">\
                        <div class="selector-chosen">\
                            ...
                            <select multiple="multiple" id="bom" name="bom[]" class="filtered target">\
                            </select>\
