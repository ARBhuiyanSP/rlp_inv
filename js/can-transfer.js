(function($) {
    $.fn.canTransfer = function(options) {
        var settings = $.extend({}, $.fn.canTransfer.defaults, options);
        var _this;
        /* #=============================================================================== */
        ...
        return this.each(function() {
            ...
            /* # Add widget markup */
            /* #=============================================================================== */
            _this.append($.fn.canTransfer.defaults.template);
            ...
            _this.data('canTransfer', _this);
            return _this;
        });
    };
    $.fn.canTransfer.defaults = {
        'template': '<table width="100%" cellspacing="0" cellpadding="0">\
                <tr>\
                    ...
                    <td width="4%">\
                        <center><div class="selector-chooser">\
                    ...
                    <td width="48%">\
                        <div class="selector-chosen">\
                            ...
                            <select multiple="multiple" id="can" name="candidate[]" class="filtered target">\
                            </select>\
