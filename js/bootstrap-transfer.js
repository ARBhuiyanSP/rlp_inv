...
function get_requsition_data() {
    let myRRRInfo = '<table width="100%" cellspacing="0" cellpadding="0">\
        <tr>\
            <td width="48%">\
            ...
            <td width="48%">\
                <div class="selector-chosen">\
                    ...
                    <select multiple="multiple" name="requisition[]" class="filtered target">\
                    </select>\
